                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm rounded-4 p-4 my-5">
                        ...
                        <form id="addProductForm" method="POST" enctype="multipart/form-data"
                            action="{{ route('add-product.store') }}">
                            @csrf
                            <div class="row">
                            ...
                            <div class="mb-3">
                                <label class="form-label update-heading"><i
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label update-heading"><i
                                            class="fa-solid fa-dollar-sign px-2"></i>Price (Rs)</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label update-heading"><i
                                            class="fa-solid fa-signal px-2"></i>Status</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label update-heading"><i class="fa-solid fa-image px-2"></i>Product
                                    Images</label>
